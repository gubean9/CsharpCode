...
namespace WebApplication4.Controllers
{
    public class HomeController : Controller
    {
        ...
        private readonly DiaryDB _studentDb;
        public HomeController(DiaryDB studentDb)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Hp")] Diary student)
        {
        ...
        //수정
        public IActionResult Update(Diary std)
        {
            //수정해야 함
            return View();
        }
