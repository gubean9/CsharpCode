...
namespace WebApplication4.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var stdData = _studentDb.Diary.ToList();
            return View(stdData);
        }
        ...
        {
            var studentsToDelete = _studentDb.Diary.Where(s => selectedStudents.Contains(s.No)).ToList();

            _studentDb.Diary.RemoveRange(studentsToDelete);
            await _studentDb.SaveChangesAsync();
